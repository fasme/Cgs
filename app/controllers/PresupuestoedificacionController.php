<?php
class PresupuestoedificacionController extends BaseController {
...
public function nuevo()
{
 	...
 	return View::make('presupuesto.crearEdificacion');
}
...
$id = Input::get("proyecto_id");
    ...
    $excel->sheet('Libro 1', function($sheet) use($id) {
        ...
        $sheet->loadView('presupuesto.xlsEdificacion')->with("id",$id);
