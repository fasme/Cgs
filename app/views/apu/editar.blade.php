...
<div class="page-header position-relative">
 ...
 {{ Form::open(array('url' => 'apu/editar/'.$partidas->id, 'class'=>'form-inline')) }}
...
<div class="row-fluid">
 ...
 {{ $partidas->obra->nombre  }} {{"/"}} {{$partidas->nombre}}
  {{Form::hidden('obra_id', $partidas->obra_id)}}

  {{Form::hidden("partida_id",$partidas->id)}}
  {{Form::text("cantidadpartida",$partidas->cantidad,array("class"=>"span2", "readonly"=>"readonly","id"=>"cantidadpartida"))}}
...
<?php $x =0; ?>
<?php $total =0; ?>
        @foreach($partidas->apu as $apus)
        @if ($apus->categoria == 1)
        <tr>
        <td>{{Form::text("apu[$i][nombre]",$apus->nombre,array('id' => "nombremaquinaria$i"))}} </td>
        <td>{{Form::text("apu[$i][unidad]",$apus->unidad,array('class'=>"span10"))}}</td>
        <td>{{Form::text("apu[$i][preciou]",$apus->preciou,array('class'=>"span10",'id' => "precioumaquinaria$i"))}}</td>
        <td>{{Form::text("apu[$i][cantidad]",$apus->cantidad,array('class'=>"span10",'id' => "cantidadmaquinaria$i"))}}</td>
        <td>{{Form::text("apu[$i][rendimiento]",$apus->rend,array('class'=>"span10",'id' => "rendimientomaquinaria$i"))}}</td>
        <td>{{Form::text("apu[$i][costo]",$apus->costo,array('class'=>"span10",'id' => "costomaquinaria$i"))}}</td>
...
<tr>
        ...
        <td>{{Form::text("apu[$i][preciou]",'',array('class'=>"span10",'id' => "precioumaquinaria$i"))}}</td>
        <td>{{Form::text("apu[$i][cantidad]",'',array('class'=>"span10",'id' => "cantidadmaquinaria$i"))}}</td>
...
<?php $total =0; ?>
        ...
        @if ($apus->categoria == 2)
        <tr>
        <td>{{Form::text("apu[$i][nombre]",$apus->nombre,array('id' => "nombrematerial$i"))}} </td>
        <td>{{Form::text("apu[$i][unidad]",$apus->unidad,array('class'=>"span10"))}}</td>
        <td>{{Form::text("apu[$i][preciou]",$apus->preciou,array('class'=>"span10",'id' => "precioumaterial$i"))}}</td>
        <td>{{Form::text("apu[$i][cantidad]",$apus->cantidad,array('class'=>"span10",'id' => "cantidadmaterial$i"))}}</td>
        <td>{{Form::text("apu[$i][rendimiento]",$apus->rend,array('class'=>"span10",'id' => "rendimientomaterial$i"))}}</td>
        <td>{{Form::text("apu[$i][costo]",$apus->costo,array('class'=>"span10",'id' => "costomaterial$i"))}}</td>
...
<tr>
        ...
        <td>{{Form::text("apu[$i][unidad]",'',array('class'=>"span10"))}}</td>
        <td>{{Form::text("apu[$i][preciou]",'',array('class'=>"span10",'id' => "precioumaterial$i"))}}</td>
        <td>{{Form::text("apu[$i][cantidad]",'',array('class'=>"span10",'id' => "cantidadmaterial$i"))}}</td>
...
<?php $total =0; ?>
        ...
        @if ($apus->categoria == 3)
        <tr>
        <td>{{Form::text("apu[$i][nombre]",$apus->nombre,array('id' => "nombremanoobra$i"))}} </td>
        <td>{{Form::text("apu[$i][unidad]",$apus->unidad,array('class'=>"span10"))}}</td>
        <td>{{Form::text("apu[$i][preciou]",$apus->preciou,array('class'=>"span10",'id' => "precioumanoobra$i"))}}</td>
        <td>{{Form::text("apu[$i][cantidad]",$apus->cantidad,array('class'=>"span10",'id' => "cantidadmanoobra$i"))}}</td>
        <td>{{Form::text("apu[$i][rendimiento]",$apus->rend,array('class'=>"span10",'id' => "rendimientomanoobra$i"))}}</td>
        <td>{{Form::text("apu[$i][costo]",$apus->costo,array('class'=>"span10",'id' => "costomanoobra$i"))}}</td>
...
<tr>
        ...
        <td>{{Form::text("apu[$i][unidad]",'',array('class'=>"span10"))}}</td>
        <td>{{Form::text("apu[$i][preciou]",'',array('class'=>"span10",'id' => "precioumanoobra$i"))}}</td>
        <td>{{Form::text("apu[$i][cantidad]",'',array('class'=>"span10",'id' => "cantidadmanoobra$i"))}}</td>
