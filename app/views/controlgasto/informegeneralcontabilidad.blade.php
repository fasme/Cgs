...
<ul class="breadcrumb">
            ...
            <li>Informe  General Contabilidad</li>
          </ul><!--.breadcrumb-->
...
<?php /*
     ...
     */ ?>
     ...
     {{ Form::open(array('url' => 'controlgasto/informegeneralcontabilidad', "target"=>"_blank")) }}
...
$anos = array($ano-1=>$ano-1,$ano=>$ano,$ano+1=>$ano+1,$ano+2=>$ano+2); ?>       
    ...
    {{Form::label("Ret. Imp. Unico Trab. ")}}
    {{Form::text("retimpunico","")}}

     {{Form::label("Ret. Tasas 10%")}}
    {{Form::text("rettasas","")}}
